...
export default class Calendar extends LightningElement {
    ...
    buildCalander(){
        ...
        for(let i=1;i<=31;i++){
            ...
            if(this.holidayList.has(i.toString())){
                ...
                ele.style = "text-align: center; background-color: red; border: 1px solid black; padding-bottom: 20px;";
            }else{
                ele.style = "text-align: center; background-color: lightblue; border: 1px solid black; padding-bottom: 20px;";
            }
    ...
    buildRow(){
        let ele = {value: ' ',
                holiday: ' ',
                style: "text-align: center; background-color: white; border: 1px solid black; padding-bottom: 20px;"};
        ...
        while (this.Row1.length<7){
            if(this.Row1.length == 0){
                this.finalCalendar[j].style = "text-align: center; background-color: red; border: 1px solid black; padding-bottom: 20px;";
            }
